<?php
       ...
       //Leer el parmetro recibido
    $idProducto = $_GET["idProducto"];
    
    //Empieza el protocolo de borrar en la base de datos
            ...
            <div class="container">
                <div class="row">
                    <div class="col">
                        ...
                        <p>El producto ha sido borrado correctamente</p>
                        
                        <p><a href="index.php" class=btn-btn-primary>Volver al listado de producto</p>
